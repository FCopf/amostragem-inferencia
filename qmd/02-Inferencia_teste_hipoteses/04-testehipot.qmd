...
3. **Experimento**: selecionamos uma amostra **aleratória** selecionando *ao acaso* $n = 15$ pessoas de hábito sedentário e medimos seus batimentos cardíacos. Os resultados são:
...
e utilizando a <a href="https://github.com/FCopf/amostragem-inferencia/blob/main/qmd/02-Inferencia_teste_hipoteses/img/Tabela_Z.pdf" target="_blank">Tabela Z</a> , encontramos a probabilidade de obtermos valores tão ou mais extremos que $-`r round(z,2)`$ e $+`r round(z,2)`$.
