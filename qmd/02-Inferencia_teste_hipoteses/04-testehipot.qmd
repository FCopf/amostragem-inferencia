...
#| fig-cap: 'Representação da parea de rejeição para a distribuição Z.'
...
#| fig-height: 6
#| label: fig-alfa-beta
#| fig-cap: 'Relação entre $\alpha$ e $\beta$, ao aceitar ou rejeitar $H_0$.'
