...
Funções: <a href="https://github.com/FCopf/amostragem-inferencia/blob/main/scripts/tcl_simetry.r" target="_blank">tcl_simetry.r</a>
...
Note que a variância de $\overline{X}$ depende do tamanho amostral $n$. Isto justifica o que será discutido no tópico **Introdução à suficiência amostral** do @sec-inferencia. 
...
Vemos portanto, como mencionado no @sec-amostrmedias, que a precisão de um experimento aumenta à medida que aumentamos o tamanho amostral, pois para amostras grandes, a probabilidade de obtermos um $\overline{X}$ distante de $\mu$ torna-se cada vez menor.
...
![Itanhaém 2014](img/robalo_itanhaem_2014.png){#fig-robalo-itanhaem-2014}

![Bertioga 2018](img/robalo_bertioga_2018.jpg){#fig-robalo-bertioga-2018}

![Atafona, sem data](img/robalo_paraiba.jpg){#fig-robalo-paraiba}
