...
Base de dados: <a href="https://github.com/FCopf/amostragem-inferencia/blob/main/datasets/altura2022.csv" target="_blank">altura2022.csv</a> e <a href="https://github.com/FCopf/amostragem-inferencia/blob/main/datasets/rhamdioglanis.csv" target="_blank">rhamdioglanis.csv</a>
...
A <a href="https://github.com/FCopf/amostragem-inferencia/blob/main/qmd/02-Inferencia_teste_hipoteses/img/Tabela_Z.pdf" target="_blank">Tabela Z</a> disponibiliza os valores de probabilidade para um grande número de valores e é apresentada na grande maioria dos livros de estatística.
...
Importe o conjunto de dados <a href="https://github.com/FCopf/amostragem-inferencia/blob/main/datasets/rhamdioglanis.csv" target="_blank">rhamdioglanis.csv</a>
